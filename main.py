...
def github_login():
    github = OAuth2Session(os.environ.get("GITHUB_CLIENT_ID")) # pripremi GitHub Oauth session
    authorization_url, state = github.authorization_url("https://github.com/login/oauth/authorize") #GitHub authorize URL
